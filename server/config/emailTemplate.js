...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Thank you for registering with QuickShow! We're excited to have you on board.</p>
            <p>Your account has been successfully created with the email address: <span class="highlight">{{email}}</span>.</p>
          

            <p>If you did not register for an account with QuickShow, please disregard this email.</p>
            <p>Thanks,</p>
            <p>The QuickShow Team</p>
        </div>
        <div class="footer">
            <p>&copy; {{current_year}} Quick SHow. All rights reserved.</p>
